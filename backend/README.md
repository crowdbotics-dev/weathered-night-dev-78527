...
## Project Structure
    ...
    ├── weathered_night_dev_78527  # Django project configurations
...
1. Clone this repo and `cd weathered_night_dev_78527`
...
2. Clone this repo and `cd weathered_night_dev_78527`
